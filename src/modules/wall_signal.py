...
def _classify(prev: _WallSnapshot, curr: _WallSnapshot) -> WallSignalResult:
    ...
    if prev.wall_ask_price > 0:
        ...
        if tested_it and pushed_through:
...
class WallTracker:
    ...
    def update(self, symbol: str, price: float, ob_signals: Optional[OrderBookSignals]) -> WallSignalResult:
